...
namespace Fruit.UIF
{
    public class PaintRecorder : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (captureScreenshot || captureVideo)
            {
                ...
                Camera camera = subCamera; // NOTE: added because there was no reference to camera in original script; must add this script to Camera
